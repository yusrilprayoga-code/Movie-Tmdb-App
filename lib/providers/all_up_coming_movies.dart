...
class _AllNowPlayingMoviesState extends State<AllNowPlayingMovies> {
  List<MovieConstantsImpl> nowPlayingMovies = [];
  ...
  void initState() {
    super.initState();
    loadAllNowPlayingMovies();
  }

  Future<void> loadAllNowPlayingMovies() async {
    final apiKey =
        'cafc0f1b384e93eef15d267d6da132fa'; // Replace with your TMDB API key
